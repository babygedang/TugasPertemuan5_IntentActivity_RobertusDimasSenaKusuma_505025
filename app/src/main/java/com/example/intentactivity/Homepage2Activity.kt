package com.example.intentactivi
...
import com.example.intentactivity.HalamanloginActivity
import com.example.intentactivity.R
import com.example.intentactivity.DaftarActivity
...
class Homepage2Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val username = intent.getStringExtra(DaftarActivity.EXTRA_USERNAME)
        ...
        btnLogout.setOnClickListener {
            ...
            val intentToLogin = Intent(this@Homepage2Activity, HalamanloginActivity::class.java)
